...
function AccountDetailsPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AccountDetailsPage.useEffect": ()=>{
            fetch(`/api/accounts/${id}`).then({
                "AccountDetailsPage.useEffect": (res)=>res.json()
            }["AccountDetailsPage.useEffect"]).then({
                "AccountDetailsPage.useEffect": (data)=>{
                    setAccount(data);
                    setLoading(false);
                }
            }["AccountDetailsPage.useEffect"]);
...
_s(AccountDetailsPage, "Esz2eD6lWPw0/6D9e4KOOQD49Ck=");
...
//# sourceMappingURL=frontend_app_%28app%29_accounts_%5Bid%5D_page_tsx_8147b478._.js.map